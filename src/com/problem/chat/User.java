...
public class User{
    ...
    private HashMap<Integer, Request> receivedAddRequests = new HashMap<Integer, Request>();
    private HashMap<Integer, Request> sentAddRequests = new HashMap<Integer, Request>();
    ...
    public void receivedAddRequest(Request req) {
    ...
    public void sentAddRequest(Request req) {
    ...
    public void removeAddRequest(Request req) {
